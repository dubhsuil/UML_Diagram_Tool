/**
 * A UML_Class stores all the data necessary for a class to be represented in a UML diagram,
 * and for a code-skeleton to be written.
 * @author Dubhsuil
 */
public class UML_Class {
	...
	/*start constructors*/
	/**
	 * creating a class with only a name and visibility, these are the fewest details
	 * required.
	 * @param name - String, the name of the class
	 * @param vis - Visibility, the enum denoting the visibility of the class
	 */
	...
	/**
	 * fully parameterized class, this is preferred method of creating a new UML_Class
	 * @param name - String, the name of the class
	 * @param vis - enum, the type of visibility for this class
	 * @param attributes - an array containing all of the class variables
	 * @param headers - an array containing all of the method headers
	 */
	public UML_Class(
			String name, 
			Visibility vis, 
			UML_Attribute[] attributes, 
			UML_Method_Header[] headers
			) {
		class_name = name;
		visible = vis;
		this.attributes = attributes;
	 ...
	 * @param att - UML_Attribute, the attribute to be added to the class
	 ...
	 * @param index - int, the index of the attribute to be removed
	 ...
	 * @param head - UML_Method_Header, the new header to add to the class
	 */
	 ...
	 * @param index - int, the index of the header to be removed
	 */
