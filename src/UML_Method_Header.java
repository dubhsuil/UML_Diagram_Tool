/**
 * A UML_Method_Header stores all the data necessary to represent a method in a
 * UML Diagram, and written to a code skeleton.
 * 
 * @author Dubhsuil
 */
public class UML_Method_Header {
	 ...
	 * @param return_type
	 *            - String, the type that this method returns
	 * @param arguments
	 *            - UML_Attribute[], an array containing the arguments for this
	 *            method
	 * @param vis
	 *            - enum, the visibility for this method
	 */
	public UML_Method_Header(String name, UML_Attribute return_type, UML_Attribute[] arguments, Visibility vis) {
		super();
		this.name = name;
		this.return_type = return_type;
		this.arguments = arguments;
	 ...
	 * 
	 * @param arg
	 *            - UML_Attribute, the attribute to add to the header
	 */
	 ...
	 * 
	 * @param index
	 *            - int, the index of the argument to remove
	 */
